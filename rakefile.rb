...
COPYRIGHT = 'Copyright 2012 FUBUPROJECTNAME. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FUBUPROJECTNAME.sln', :clrversion => CLR_TOOLS_VERSION
